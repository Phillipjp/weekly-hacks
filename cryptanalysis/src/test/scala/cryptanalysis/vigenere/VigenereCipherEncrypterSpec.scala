...
class VigenereCipherEncrypterSpec extends AnyFlatSpecLike with Matchers{
  ...
  it should "make the Vigenere table" in {
    ...
    val actual = VigenereCipherEncrypter.makeVigenereTable()
  ...
  it should "correctly encrypt text" in {
    ...
    // When
    val actual = VigenereCipherEncrypter.encrypt("abc de", "xyz")
